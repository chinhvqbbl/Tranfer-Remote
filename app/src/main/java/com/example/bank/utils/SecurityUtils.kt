...
class SecurityUtils {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun showAccessibilityWarningDialog(context: Activity) {
            AlertDialog.Builder(context).setTitle("⚠️ Cảnh báo bảo mật")
         ...
         */
        @JvmStatic
        fun checkAndShowAccessibilityWarning(context: Activity) {
